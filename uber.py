...
# Assuming you have the trained linear regression model stored in the variable 'regression'

# Input values for prediction
input_data = {
    'pickup_longitude': -73.9804,
    'pickup_latitude': 40.7488,
    'dropoff_longitude': -73.9928,
    ...
    'month': 6,
    'year': 2022,
    'dayofweek': 2,  # Assuming 0 is Monday, 1 is Tuesday, and so on
    'dist_travel_km': 10  # Assuming a travel distance of 10 km
}
...
fare_prediction = regression.predict(input_df)

# Display the predicted fare amount
print(f"Predicted Fare Amount: ${fare_prediction[0]:.2f}")
